...
do 
    ...
    instance_id=$(aws ec2 run-instances --image-id ami-041e2ea9402c46c32  --instance-type $instance_type  --security-group-ids sg-0068acc7a96fbb265  --subnet-id subnet-0717dc25807226641 --query "Reservations[].Instances[].InstanceId" --output text)
